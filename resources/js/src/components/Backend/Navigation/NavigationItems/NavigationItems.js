...
export default ({ data, sidedrawerToggle, logoutHandler, role, messages = [], notifications = [], date: { weekDay, day, month, year }, clock: { hours, minutes, seconds } }) => {
    ...
    return <div className="px-3 bg-darkhead flex-fill d-flex align-items-center text-white text-large position-relative" style={{ height: 70 }}>
        <Nav className="mr-auto d-flex align-items-center" navbar>
            ...
            <div className="d-none d-lg-block" style={{ width: 190 }}>
                ...
                <strong className="text-orange">TIME : {hours} : {minutes} : {seconds}</strong>
            </div>
            <div className="d-none d-lg-block">
                <strong className="text-orange-50">DATE : {weekDay} {day} {month} {year}</strong>
            </div>
        </Nav>
        ...
        <Modal isOpen={modal} toggle={toggle}>
            ...
            <ModalBody className="text-center">
                ...
                <div>
                    ...
                    <Button color="brown" onClick={toggle}>Close <FontAwesomeIcon icon={faTimes} fixedWidth /></Button>
                </div>
            </ModalBody>
        </Modal>
    </div>;
