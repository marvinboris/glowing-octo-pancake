        ...
        if (loading) content = <Col xs={12}>
            ...
            if (messages) {
                ...
                content = (
                    <>
                        <Row>
                            <List array={messagesData} data={JSON.stringify(messages)} bordered add="New Message" content={<Add />} icon={faEnvelope} title="Sent Messages" className="bg-white shadow-sm"
                                fields={[
...
const mapDispatchToProps = dispatch => ({
    get: () => dispatch(actions.getSentMessages()),
